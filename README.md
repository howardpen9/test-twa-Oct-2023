...
1. Change the `Tact` file in folder `tact-contracts`. Once ready, type `yarn build-tact` to compile the contract code.
2. Run `npm run dev` and edit the code as needed
3. On push to the `main` branch, the app will be automatically deployed via github actions.
